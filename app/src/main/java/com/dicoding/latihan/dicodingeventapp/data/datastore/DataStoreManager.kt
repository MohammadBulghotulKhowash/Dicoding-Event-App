package com.dicoding.latihan.dicodingeventapp.data.datastore
...
class DataStoreManager private constructor(private val dataStore: DataStore<Preferences>){
    ...
    suspend fun saveThemeSetting(isDarkModeActived: Boolean) {
        dataStore.edit { preferences ->
            preferences[THEME_KEY] = isDarkModeActived
        }
    }
